...
const TripHistory = () => {
  ...
  if (error) return <div className="text-center py-8"><p className="text-gray-500">Failed to load trip history</p></div>;
      ...
      <div>
        ...
        {trips.length === 0 ? (
          ...
          <div className="space-y-4">
            {trips.map((trip) => (
              <motion.div key={trip.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
